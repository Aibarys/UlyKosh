...
private enum PictogramLibrary {
    ...
    private static func build(_ kind: Pictogram, _ b: inout PathBuilder) {
        ...
        case .yurt:
            // стена кереге + конический купол с перегибом
            b.poly([(8, 90), (8, 62), (6, 62), (22, 40), (42, 26), (58, 26), (78, 40), (94, 62), (92, 62), (92, 90)])
            // просвет пояса на карнизе
            b.poly([(10, 60), (90, 60), (90, 63), (10, 63)], hole: true)
            // дверь
            b.poly([(42, 90), (42, 74), (46, 68), (54, 68), (58, 74), (58, 90)], hole: true)
            // шанырак
            b.ellipse(50, 22, 9, 5)
            b.ellipse(50, 22, 5, 2.5, hole: true)
            b.poly([(49, 8), (51, 8), (51, 20), (49, 20)])
